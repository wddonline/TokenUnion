 ...
 */
package com.iconiz.tokenunion.permission;
...
import com.iconiz.tokenunion.widget.AlertDialog;

/**
 * Created by Bit Cat on 2016/12/27.
 */
public class SettingDialog {
    ...
    public SettingDialog setSettingDialogListener(SettingDialogListener listener) {
        ...
        public void onClick(DialogInterface dialog, int which) {
            switch (which) {
                case DialogInterface.BUTTON_NEGATIVE:
                    ...
                    if (mListener != null) mListener.onCancelClicked();
                    break;
                case DialogInterface.BUTTON_POSITIVE:
                    mSettingService.execute();
                    if (mListener != null) mListener.onSettingClicked();
                    break;
            }
        }
    };
