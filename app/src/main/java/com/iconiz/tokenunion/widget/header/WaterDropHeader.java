 ...
 */
package com.iconiz.tokenunion.widget.header;
...
import com.iconiz.tokenunion.widget.header.internal.MaterialProgressDrawable;
import com.iconiz.tokenunion.widget.header.waterdrop.WaterDropView;
...
public class WaterDropHeader extends InternalAbstract implements RefreshHeader {
    ...
    public WaterDropHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        progressDrawable.setBounds(0, 0, dip2px(20), dip2px(20));
        ...
        thisGroup.addView(mImageView, dip2px(30), dip2px(30));
    }
