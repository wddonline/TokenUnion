...
/**
 * Created by Bit Cat on 2016/12/12.
 */
public abstract class AlertDialog {
    ...
    private static class Api20Dialog extends AlertDialog {
        ...
        private androidx.appcompat.app.AlertDialog alertDialogSupport;
    ...
    private static class Api20Builder implements Builder {
        ...
        private androidx.appcompat.app.AlertDialog.Builder builderSupport;
        ...
        private Api20Builder(@NonNull Context context, @StyleRes int themeResId) {
            builderSupport = new androidx.appcompat.app.AlertDialog.Builder(context, themeResId);
        }
