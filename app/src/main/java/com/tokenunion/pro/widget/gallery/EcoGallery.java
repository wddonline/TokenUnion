package com.tokenunion.pro.widget.gallery;
...
public class EcoGallery extends EcoGalleryAbsSpinner implements GestureDetector.OnGestureListener {
	...
	private void setUpChild(View child, int offset, int x, boolean fromLeft) {
		...
		// Get measure specs
		int childHeightSpec = getChildMeasureSpec(mHeightMeasureSpec, mSpinnerPadding.top + mSpinnerPadding.bottom,
				lp.height);
		int childWidthSpec = getChildMeasureSpec(mWidthMeasureSpec, mSpinnerPadding.left + mSpinnerPadding.right,
				lp.width);
